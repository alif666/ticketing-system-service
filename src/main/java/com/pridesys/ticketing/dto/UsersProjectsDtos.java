...
public final class UsersProjectsDtos {
    ...
    public record UpdateUserRequest(@NotBlank @Size(max = 120) String name, @Size(max = 30) String mobile,
                                    @Size(max = 120) String designation, @Size(max = 120) String office,
                                    Boolean active) {
    }

    public record UserResponse(long id, String email, String role, String name, String mobile, String designation,
                               String office, boolean active, Long clientId) {
    }
    ...
    public record CreateProjectRequest(@NotBlank @Size(max = 160) String name,
                                       @NotBlank @Size(max = 30) String shortCode,
                                       @Size(max = 1000) String description) {
    }

    public record UpdateProjectRequest(@NotBlank @Size(max = 160) String name, @Size(max = 1000) String description,
                                       Boolean active) {
    }
