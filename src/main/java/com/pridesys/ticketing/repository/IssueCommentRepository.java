...
public interface IssueCommentRepository extends JpaRepository<IssueCommentEntity, Long> {
    org.springframework.data.domain.Page<IssueCommentEntity> findByIssueIdOrderByCreatedAtAsc(long issueId, org.springframework.data.domain.Pageable pageable);
}
