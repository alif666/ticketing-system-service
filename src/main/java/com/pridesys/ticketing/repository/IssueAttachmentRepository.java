...
public interface IssueAttachmentRepository extends JpaRepository<IssueAttachmentEntity, Long> {
    org.springframework.data.domain.Page<IssueAttachmentEntity> findByIssueIdOrderByCreatedAtAsc(long issueId, org.springframework.data.domain.Pageable pageable);
}
